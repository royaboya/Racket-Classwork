...
(define (p2a b x1 x2) x1)


(: p2b (All (X) (-> Boolean X X X)))
(define (p2b b x1 x2) x2)

(: p2c (All (X) (-> Boolean X X X)))
(define (p2c b x1 x2) (if b x1 x2))

(: p2d (All (X) (-> Boolean X X X)))
(define (p2d b x1 x2) (if (not b) x1 x2))
